...
class CitiesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables($query)->setRowId('id')
            ...
            ->addColumn('ar_name','admin.cities.buttons.name')
            ->addColumn('checkbox','<input type="checkbox" class="selected_data" name="selected_data[]" value="{{ $id }}">')
            ->addColumn('edit','admin.cities.buttons.edit')
            ->addColumn('delete','admin.cities.buttons.delete')
            ->rawColumns(['checkbox','ar_name','edit', 'delete'])
            ;
    }
