        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{url(AdminPath().'/currencies')}}" data-toggle="tooltip" title="{{trans('orbscope.show-all')}}   {{trans('orbscope.currencies')}}">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        {!! Form::open(['files'=>true,'route'=>['currencies.update', $edit->id],'method' => 'PATCH','class'=>'form-horizontal form-row-seperated']) !!}
                        <div class="row">
                            ...
                            <div class="form-group{{ $errors->has('ar_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    {!! Form::text('name',$edit->name, ['class'=>'form-control','id'=>'ar_name','placeholder'=>trans('orbscope.name'),'required'=>'required']) !!}
                                    <i class="fa fa-spinner fa-spin loading hidden"></i>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label" for="symbol">{{trans('orbscope.symbol')}} <span class="required" aria-required="true"> * </span></label>
                                <div class="col-md-10">
                                    {!! Form::text('symbol',$edit->symbol,['class'=>'form-control','id'=>'symbol','placeholder'=>trans('orbscope.symbol'),'required'=>'required']) !!}
                                    @if ($errors->has('symbol'))
                                        <span class="help-block">
                                            <strong style="color: red">{{ $errors->first('symbol') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="status">{{trans('orbscope.status')}} </label>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue">{{trans('orbscope.edit')}} {{trans('orbscope.currencies')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
