        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{url(AdminPath().'/Customer/create')}}" data-toggle="tooltip" title="{{trans('orbscope.add')}}  {{trans('orbscope.Customer')}}">
                            <i class="fa fa-plus"></i>
                        </a>
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ url(AdminPath().'/Customer/'.$show->id.'/edit')}}" data-toggle="tooltip" title="{{trans('orbscope.edit')}}  {{trans('orbscope.Customer')}}">
                            <i class="fa fa-edit"></i>
                        </a>
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{url(AdminPath().'/Customer')}}" data-toggle="tooltip" title="{{trans('orbscope.show-all')}}   {{trans('orbscope.Customer')}}"><i class="fa fa-list"></i></a>
                                ...
                                <div class="row static-info">
                                    <div class="col-md-12">
                                                    ...
                                                    <div class="carousel-inner" role="listbox">
                                                        @foreach(explode('|', $show->files) as $key => $image)
                                                            ...
                                                            @if (getTypeFile(getEx($image))['fileType'] == 'Adobe Acrobat')
                                                                <a href="{{ url(AdminUrl('download_customer/'.$image))}}" style="margin: 3px;" target="_blank" class="btn btn-large blue pull-right">
                                        ...
                                        <div class="clearfix"></div>
                                           <form action="{{url('admin/add_files/customer/'.$show->id)}}" method="post" enctype="multipart/form-data">
                                               {{ csrf_field() }}
