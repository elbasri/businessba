        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{url(AdminPath().'/Customer')}}" data-toggle="tooltip" title="{{trans('orbscope.show-all')}}   {{trans('orbscope.Customer')}}">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        {!! Form::open(['files'=>true, 'url' =>AdminPath().'/Customer/'.$edit->id,'method' => 'PUT','class'=>'form-horizontal form-row-seperated']) !!}
                        <div class="row">
                            ...
                            <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    {!! Form::text('mobile',$edit->mobile,['class'=>'form-control','id'=>'mobile','placeholder'=>trans('orbscope.mobile')]) !!}
                                </div>
                            </div>

                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                <label class="col-md-2 control-label" value="{{$edit->phone}}" for="phone">{{trans('orbscope.phone')}}</label>

                                <div class="col-md-10">
                                    {!! Form::text('phone',$edit->phone,['class'=>'form-control','id'=>'phone','placeholder'=>trans('orbscope.phone')]) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="code" value="{{$edit->code}}" id="code" required class="form-control" placeholder="{{trans('orbscope.code')}}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <select class="form-control select2" name="employee_id"  data-placeholder="{{trans('orbscope.representor')}}">
                                        ...
                                        @foreach($employee as $type)
                                            <option value="{{$type->id}}" {{$edit->employee_id==$type->id?'selected':''}}>{{VarByLang($type->name,GetLanguage())}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <select class="form-control select2" name="type_id"  data-placeholder="{{trans('orbscope.customer_type')}}">
                                        ...
                                        @foreach($cutype as $ty)
                                            <option value="{{$ty->id}}" {{$edit->type_id==$ty->id?'selected':''}}>{{VarByLang($ty->name,GetLanguage())}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue">{{trans('orbscope.edit')}} {{trans('orbscope.Customer')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
