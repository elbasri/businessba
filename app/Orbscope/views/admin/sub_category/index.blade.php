                ...
                <div class="portlet-body">
                    <div class="tabbable-line">
                        <ul class="nav nav-tabs nav-tabs-lg">
                            <li >
                                <a  href="{{url(AdminPath().'/sub_category/'.$sub->id.'/create')}}" >+ اضافة مجال فرعي</a>
                            </li>
                            <br/>
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    <div class="col-md-12">
                                        {!! Form::open([
                                           'method' => 'post',
                                           'url' => [AdminPath().'/sub_category/multi_delete']
                                           ]) !!}

                                        {!! $dataTable->table(['class'=> 'table table-bordered table-striped table-condensed flip-content'],true) !!}
