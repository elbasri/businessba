                                ...
                                <div class="row static-info">
                                    <div class="col-md-12">
                                                    ...
                                                    <div class="carousel-inner" role="listbox">
                                                        @foreach(explode('|', $show->files) as $key => $image)
                                                            ...
                                                            @if (getTypeFile(getEx($image))['fileType'] == 'Adobe Acrobat')
                                                                <a href="{{ url(AdminUrl('download_projects/'.$image))}}" style="margin: 3px;" target="_blank" class="btn btn-large blue pull-right">
                                        ...
                                        <div class="clearfix"></div>
                                           <form action="{{url('admin/add_files/agent/'.$show->id)}}" method="post" enctype="multipart/form-data">
                                               {{ csrf_field() }}
