    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{trans('orbscope.delete')}} {{ VarByLang($name,GetLanguage()) }} ! </h4>
            </div>
            <div class="modal-body">
                {{trans('orbscope.ask-delete')}} : {{ VarByLang($name,GetLanguage()) }}
            </div>
            <div class="modal-footer">
                {!! Form::open([
               'method' => 'DELETE',
               'route' => ['Representor_list.destroy', $id]
               ]) !!}
