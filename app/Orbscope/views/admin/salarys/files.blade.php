            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{url(AdminPath().'/employees/salarys')}}" data-toggle="tooltip" title="{{trans('orbscope.show-all')}}   {{trans('orbscope.salarys')}}"><i class="fa fa-list"></i></a>
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="row static-info">
                                    <div class="col-md-12">
                                        ...
                                        @if ($show->salary_files != null)
                                            <div class="col-md-12">
                                                <div class="col-md-2"><strong>{{trans('orbscope.files')}} : </strong></div>
                                                <div class="col-md-10">
                                                    <div class="carousel-inner" role="listbox">
                                                        @foreach(explode('|', $show->salary_files) as $key => $image)
                                                            ...
                                                            @if (getTypeFile(getEx($image))['fileType'] == 'Adobe Acrobat')
                                                                <a href="{{ url(AdminUrl('download_salary/'.$image))}}" style="margin: 3px;" target="_blank" class="btn btn-large blue pull-right">
                                        ...
                                        <div class="clearfix"></div>
                                           <form action="{{url('admin/add_files/salary/'.$show->id)}}" method="post" enctype="multipart/form-data">
                                               {{ csrf_field() }}
                                          ...
                                          <br/>
                                               <div class="form-group" id="upload">
                                                   ...
                                                   <div class="col-md-10">
                                                       @php
                                                           if($show->salary_files != ''){
                                                               $pdfs = explode('|',$show->salary_files);
                                                           }else{
                                                               $pdfs = null;
                                                           }
                                                       @endphp
